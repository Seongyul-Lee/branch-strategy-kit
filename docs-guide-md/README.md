...
| 역할 | 읽을 문서 | 소요 시간 |
|---|---|---|
| 팀 프로젝트에 키트를 **도입하려는 관리자** | [1-ADMIN_SETUP.md](./docs/1-ADMIN_SETUP.md) | ~15분 |
| 관리자가 세팅을 마친 프로젝트에 **합류한 팀원** | [2-MEMBER_SETUP.md](./docs/2-MEMBER_SETUP.md) | ~5분 |
| 세팅이 끝났고, **매일 쓰는 워크플로우**가 궁금함 | [3-DAILY_WORKFLOW.md](./docs/3-DAILY_WORKFLOW.md) | 레퍼런스 |
| **에러**가 났다 | [TROUBLESHOOTING.md](./docs/TROUBLESHOOTING.md) | 필요할 때 |
...
> 💡 위 선택 의존성은 [`bootstrap.sh`](./docs/2-MEMBER_SETUP.md)로 한 번에 설치할 수 있습니다.
